...
\textcolor{red}{write about machine learning and ANNs. give background about CNNs and their use within computer vision using object classification as an example and mention the work in AlexNet}
